...
1. Start from the complete registered/acquired item from Stage 4.
...
Confirm that the same registered custom identity reaches the expected presentation owner and the asset is loaded/released through the correct lifetime.

## Before continuing

Presentation success does not cover gameplay effects, persistence, missing-package behaviour, or compatibility with other item families.
