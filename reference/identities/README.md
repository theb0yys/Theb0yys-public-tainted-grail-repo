<!-- Canonical documentation path. Migrated from docs/reference/IDENTITY_CATALOGUE.md. -->
# Identity Catalogue
...
For the identity model itself, see [Identity: GUIDs, Names, Addresses, and Stable IDs](../../docs/reference/IDENTITY_GUIDS_NAMES.md).
