<!-- Canonical Wave 5 location. Migrated from docs/reference/IDENTITY_GUIDS_NAMES.md. -->
...
See [Identity Catalogue](../../docs/reference/IDENTITY_CATALOGUE.md) for curated example identities.
