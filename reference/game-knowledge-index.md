...
- known successful/failed routes → [What Works, What Does Not, and Why](../case-studies/failures-and-fixes/README.md)
- cross-cutting rules → [Golden Rules](../learn/golden-rules.md)
