...
1. [Add your first new item](../first-mod/first-content-authoring.md) on the currently proven Mono/BepInEx 5 item lane.
...
3. Use the [technical handbook](../../reference/README.md) for identity, templates, hooks, ownership, assets, persistence and failure reasoning.
