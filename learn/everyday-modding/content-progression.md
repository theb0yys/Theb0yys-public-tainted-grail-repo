...
- the [technical handbook](../../reference/README.md);
- the [Content Domains](../../reference/content-domains.md) reference;
...
Use [Content Domains](../../reference/content-domains.md) as the map.

Then use [Research Method](../../how-to/reverse-engineering/discovery.md) to extract the next proven process from the working evidence.
