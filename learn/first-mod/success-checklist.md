...
Continue to **[Learn the Everyday Modding Loop](../everyday-modding/README.md)**.

For the reasoning behind the custom-item process, use **[Items: Proven Custom Item Integration](../../systems/gameplay/items.md)**.
