...
- **First game change:** IL2CPP can use [the first runtime change](../everyday-modding/first-il2cpp-game-change.md); both lanes move toward a [verified real game patch](../everyday-modding/first-real-patch-rules.md).
- **First complete mod:** [finish one small mod end-to-end](../everyday-modding/first-complete-mod.md).
...
4. Use the [technical handbook](../../reference/README.md) when the tutorial links to a system such as identity, templates, hooks, assets or persistence.
...
Continue to [the everyday modding loop](../everyday-modding/README.md) when you can repeat your first test without guessing:
