<!-- Canonical Wave 5 location. Migrated from docs/reference/SERIALIZATION_ARCHIVES.md. -->
...
For runtime template ownership, see [Templates and Registries](../../docs/reference/TEMPLATES_REGISTRIES.md).
