<!-- Canonical Wave 5 location. Migrated from docs/reference/PERSISTENCE_ARCHITECTURE.md. -->
...
For concrete save lifecycle surfaces, see [Saving and Persistence](../../docs/reference/SAVING_PERSISTENCE.md).
