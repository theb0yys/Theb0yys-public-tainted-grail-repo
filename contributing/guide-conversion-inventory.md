...
| 6 | [Combat pressure without raw damage multipliers](../research/case-studies/combat/pressure-not-damage.md) | `guides/tasks/gameplay/tune-combat-pressure.md` | existing: `examples/mono/combat/combat-pressure-poise/` | Guide |
| 7 | [Poise is not stagger](../research/case-studies/combat/poise-not-stagger.md) | `guides/tasks/gameplay/tune-poise-safely.md` | existing: `examples/mono/combat/combat-pressure-poise/` | Guide |
...
| 9 | [Auto-unlock without bypassing every lock rule](../research/case-studies/lockpicking/auto-unlock-boundary.md) | `guides/tasks/gameplay/auto-unlock-with-native-gates.md` | existing: `examples/mono/gameplay/auto-unlock/` | Guide |
...
| 17 | [Carry tweak must follow the current stat instance](../research/case-studies/stats/carry-stale-tweak.md) | `guides/tasks/gameplay/change-carry-capacity-safely.md` | existing: `examples/mono/gameplay/carry-capacity/` | Guide |
| 18 | [Projectile route coverage and aim correction](../research/case-studies/magic/projectile-route-and-aim.md) | `guides/tasks/gameplay/tune-projectile-speed-without-breaking-aim.md` | existing: `examples/mono/magic/projectile-speed-and-aim/` | Guide |
...
| 36 | [Container rules: post-roll and save-backed](../research/case-studies/economy/container-row-boundary.md) | `guides/tasks/gameplay/change-post-roll-container-contents.md` | existing: `examples/mono/gameplay/container-post-roll-rules/` | Guide |
| 37 | [Native service reuse and submenu ownership](../research/case-studies/bonfire/native-service-reuse.md) | `guides/tasks/ui/build-a-native-looking-bonfire-services-menu.md` | existing: `examples/mono/ui/bonfire-services-submenu/` | Guide |
...
| 42 | [Inventory suite: presentation without a second inventory](../research/case-studies/ui/inventory-truth-boundary.md) | `guides/tasks/ui/build-a-read-only-inventory-projection.md` | existing: `examples/mono/ui/inventory-readonly-projection/` | Guide |
| 43 | [Native HUD ownership vs custom visual proof](../research/case-studies/ui/hud-owner-and-visual-proof.md) | `guides/tasks/ui/customize-the-hud-with-separate-system-and-visual-proof.md` | existing: `examples/mono/ui/hud-visibility-and-theme/` | Guide |
...
| 51 | [Combat VFX sidecars](../research/case-studies/rendering/combat-vfx.md) | `guides/tasks/rendering/build-a-bounded-combat-vfx-sidecar.md` | existing: `examples/mono/rendering/combat-vfx-sidecar/` | Guide |
...
| 53 | [Native save completion observer](../research/case-studies/persistence/native-save-completion-observer.md) | `guides/tasks/saving/observe-native-save-completion.md` | existing: `examples/mono/infrastructure/save-observer-backup/` | Guide |
