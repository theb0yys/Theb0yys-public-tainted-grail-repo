...
| 3 | [Discovery before mutation](../research/case-studies/frameworks/discovery-before-mutation.md) | **PROVEN** | Sample consumer proved dependency/load order, read-only trust/discovery/registration and fail-closed guardrails with zero mutation capability. | planned: `guides/tasks/interoperability/build-a-read-only-framework-consumer.md` | existing: `examples/mono/infrastructure/core-readonly/` | **EXISTING_EXAMPLE** |
...
| 20 | [Native mount velocity tuning](../research/case-studies/gameplay/mount-velocity.md) | **PROVEN** | Live 1.25 running/turning getter proof plus user smoke through mount, movement, transitions, save/load and quit/relaunch. | planned: `guides/tasks/gameplay/change-mount-speed.md` | planned: `examples/mono/gameplay/mount-velocity/` | **NOT_STARTED** |
...
| 25 | [Existing item grants](../research/case-studies/content/item-grants.md) | **PROVEN** | Avalon Cheat Panel uses native template/item/world/inventory ownership; live screenshot confirmed a single successful Grant receipt. | planned: `guides/tasks/items/grant-an-existing-item.md` | planned: `examples/mono/items/grant-existing-item/` | **NOT_STARTED** |
...
| 28 | [Native horse velocity: Proof125](../research/case-studies/movement/native-horse-velocity-proof.md) | **PROVEN** | Live 1.25/1.25 getter proof and later smoke through movement, transition, save/load and relaunch; broader mount ownership excluded. | planned: `guides/tasks/gameplay/change-horse-running-and-turning-speed.md` | planned: `examples/mono/gameplay/horse-velocity-proof/` | **NOT_STARTED** |
...
| 44 | [Native hero footstep replacement](../research/case-studies/audio/footsteps.md) | **PROVEN** | Runtime path loaded custom audio, installed exact scoped patch and logged 57 custom plays while native footstep suppression was enabled. | planned: `guides/tasks/audio/replace-hero-footsteps.md` | existing: `examples/mono/audio/footstep-replacement/` | **EXISTING_EXAMPLE** |
| 45 | [Tainted Music: own your lane, not all audio](../research/case-studies/audio/tainted-music-lane-ownership.md) | **PARTIAL** | Ownership architecture is established, but the private matrix retained audible-validation gaps for overlap/transitions/exceptions. | planned: `guides/tasks/audio/build-a-contextual-music-mod.md` | planned: `examples/mono/audio/contextual-music/` | **NOT_STARTED** |
