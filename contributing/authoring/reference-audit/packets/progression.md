# Wave 5 Packet — Progression and Skills

## Reader job

Separate XP/proficiency/talent/stat ownership from reversible tuning and effect mechanics.

## Legacy source pages

- `docs/reference/PROGRESSION_SKILLS.md`
...
|---|---|---|
| `PROGRESSION_SKILLS.md` | `systems/progression/README.md` | `mechanics/progression/tuning-and-effects.md` |
...
- XP source vs sink;
- native progression/save ownership;
- StatTweak role;
- talent transaction boundaries;
- persistence risks;
- reversible intervention guidance;
