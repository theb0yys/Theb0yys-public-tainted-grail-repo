# Wave 5 Packet — Assets, Addressables, and Presentation

## Reader job

Separate asset/resource ownership and lifecycle from the mechanic of loading, binding, and presenting mod-owned assets.
...
|---|---|---|
| `ASSETS.md` | `systems/assets/README.md` | `mechanics/assets/loading-and-presentation.md` |
...
- AssetBundle/Addressables ownership;
- FoA asset-reference boundaries;
- presentation ownership;
- load/adopt/release ordering;
- asset-loaded ≠ gameplay-registered rule;
