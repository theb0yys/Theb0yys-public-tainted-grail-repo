# Wave 5 Packet — Localisation and Babel

## Reader job

Separate Questline Babel/localisation architecture from bounded custom-text/localisation procedures.

## Legacy source pages

- `docs/reference/LOCALISATION_BABEL.md`
...
|---|---|---|
| `LOCALISATION_BABEL.md` | `systems/localisation/README.md` | `mechanics/localisation/custom-text.md` |
...
- Babel/LocString identity;
- runtime provider/caching;
- fallback text boundaries;
- numeric-ID risks;
- voice/audio separation;
- hot-language lifecycle;
