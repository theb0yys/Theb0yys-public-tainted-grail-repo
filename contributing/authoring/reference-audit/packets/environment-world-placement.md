# Wave 5 Packet — Environment, Weather, Placement, and Navigation

## Reader job

Separate environment/world-state and placement/navigation ownership from provider tuning and spawn-safety mechanics.

## Legacy source pages

- `docs/reference/WEATHER_ENVIRONMENT.md`
- `docs/reference/WORLD_PLACEMENT_NAVIGATION.md`
...
|---|---|---|
| `WEATHER_ENVIRONMENT.md` | `systems/environment/README.md` | `mechanics/environment/weather-and-presentation.md` |
| `WORLD_PLACEMENT_NAVIGATION.md` | `systems/world/placement-and-navigation.md` | `mechanics/world/placement-and-spawn-safety.md` |
...
- one truth owner for weather;
- state vs rendering provider;
- coordinates vs placement safety;
- topology/path evidence;
- spawn anchor vs spawn definition;
- session vs persistent placement;
