# Wave 5 Packet — Map, Travel, Portals, and Scene Transition

## Reader job

Separate map/discovery/portal/scene ownership from task-specific travel and scene intervention mechanics without collapsing the different stages.

## Legacy source pages

- `docs/reference/MAP_DISCOVERY_FAST_TRAVEL.md`
- `docs/reference/MAP_TRAVEL.md`
- `docs/reference/WORLD_SCENES_TRAVEL.md`
...
|---|---|---|
| `MAP_DISCOVERY_FAST_TRAVEL.md` | `systems/world/map-discovery-fast-travel.md` | `mechanics/world/map-discovery-fast-travel.md` |
| `MAP_TRAVEL.md` | `systems/world/map-portals-travel.md` | `mechanics/world/map-portals-travel.md` |
| `WORLD_SCENES_TRAVEL.md` | `systems/world/scenes-and-travel.md` | `mechanics/world/scene-and-travel-intervention.md` |
...
- map UI vs travel execution;
- portal vs scene owner;
- SceneService/Addressables lifecycle;
- cross-scene identity;
- actor cleanup/reconstruction boundaries;
- fog/marker/travel separation;
