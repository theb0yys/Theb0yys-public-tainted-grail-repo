# Wave 5 Packet — Crime, Stealth, and Bounty

## Reader job

Separate the native crime/bounty/guard authority from reversible stealth/crime intervention mechanics.

## Legacy source pages

- `docs/reference/CRIME_STEALTH_BOUNTY.md`
...
|---|---|---|
| `CRIME_STEALTH_BOUNTY.md` | `systems/crime/README.md` | `mechanics/crime/intervention-patterns.md` |
...
- crime owner authority;
- witness/bounty/guard lifecycle;
- stolen-item/equipment boundaries;
- reversible stat-tweak guidance;
- persistent consequence save boundary;
