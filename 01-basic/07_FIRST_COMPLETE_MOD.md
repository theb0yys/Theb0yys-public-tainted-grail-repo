...
- [Understand How Mods Work](../02-foundational/README.md) to understand the engineering underneath the working mod.
- [Tainted Grail Mod Cookbook](../examples/mod-cookbook/README.md) for more kinds of changes.
- [Build Robust Game Changes](../03-advanced/README.md) when your mod needs stronger compatibility, diagnostics, packaging, or conflict handling.
