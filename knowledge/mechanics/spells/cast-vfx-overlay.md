...
Do not publish heuristic family names as native game truth. Use [Name heuristic vs native identity](../../../research/methods/name-heuristic-vs-native-identity.md) when promoting spell knowledge.
