...
- identity questions → [Identity](identities/identity-guids-names.md)
- native owner/lifecycle → [FoA Systems Map](../systems/game-systems-map.md)
- hooks → [Hook Catalogue](hooks/catalogue.md) and [Hook Research Inventory](hooks/catalogue.md)
- reusable modding mechanisms → [Mechanics Catalogue](mechanics-catalogue.md)
- known successful/failed routes → [What Works, What Does Not, and Why](../../research/case-studies/failures-and-fixes/README.md)
- cross-cutting rules → [Golden Rules](../../guides/learning-paths/golden-rules.md)
