...
This page describes the repository's debugging discipline. Exact diagnostic markers differ by mod/process. Use [Testing and Evidence Status](../EVIDENCE.md) when recording formal proof states.
