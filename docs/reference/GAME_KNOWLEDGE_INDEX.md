...
- identity questions → [Identity](IDENTITY_GUIDS_NAMES.md)
- native owner/lifecycle → [FoA Systems Map](GAME_SYSTEMS_MAP.md)
- hooks → [Hook Catalogue](HOOK_CATALOGUE.md) and [Hook Research Inventory](HOOK_RESEARCH_INVENTORY.md)
- reusable modding mechanisms → [Mechanics Catalogue](MECHANICS_CATALOGUE.md)
- known successful/failed routes → [What Works, What Does Not, and Why](WORKS_FAILS_WHY.md)
- cross-cutting rules → [Golden Rules](GOLDEN_RULES.md)
