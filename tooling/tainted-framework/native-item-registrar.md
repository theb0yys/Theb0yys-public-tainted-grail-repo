...
Until the relevant runtime/persistence gates are explicitly ready, use the public [item mechanics](../../mechanics/items/register-custom-template.md) as evidence/architecture guidance rather than assuming a framework call is safe.
