...
| Tainted Framework | **PUBLIC — MONO + IL2CPP** | Nexus Mods: https://www.nexusmods.com/taintedgrailthefallofavalon/mods/312 | public distribution is cross-runtime; current engineering IL2CPP evidence line reaches `0.1.38`, but public package/API versioning must still be checked independently | Tainted Framework is the shared cross-runtime dependency layer; only named promoted consumer surfaces are author contracts |
