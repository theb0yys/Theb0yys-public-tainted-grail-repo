...
- [One-session native companion](native-session-companion/README.md)
- [Fixed native Wyrdspirit encounter](fixed-native-encounter/README.md)

These examples expose the concrete game-owned types, hooks and lifecycle patterns documented by the corresponding guides.
