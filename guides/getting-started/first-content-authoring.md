...
- the [Items: Proven Custom Item Integration](../../knowledge/systems/gameplay/items.md) reference page open beside this tutorial.
...
Read [Identity: GUIDs, Names, Addresses, and Stable IDs](../../knowledge/reference/identities/identity-guids-names.md) before changing these concepts.
...
See [Templates and Registries](../../knowledge/systems/core/templates-registries.md).
...
See [Native Object Ownership](../../knowledge/systems/core/native-object-ownership.md).
...
See [Lifecycle and Hooks](../../knowledge/reference/hooks/lifecycle.md).
...
**It works until you restart/load a save:** current-session registration is not the same as persistence proof. Read [Saving and Persistence](../../knowledge/systems/world/saving-persistence.md).

**You tried to apply the same process to a weapon/creature:** stop and map that domain's native owners first. See [Content Domains](../../knowledge/reference/content-domains.md).

## Where to go next

- [Items: Proven Custom Item Integration](../../knowledge/systems/gameplay/items.md) — the complete rationale and proof boundary.
- [Failures and Constraints](../learning-paths/golden-rules.md) — why the process narrowed to this shape.
- [Hook Catalogue](../../knowledge/reference/hooks/catalogue.md) — exact researched lifecycle surfaces.
- [Research Method](../tasks/reverse-engineering/discovery.md) — how to investigate the next content domain without inventing missing steps.
