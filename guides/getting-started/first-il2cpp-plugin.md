...
Then continue directly to **[Make Your First IL2CPP Game Change](../learning-paths/everyday-modding/first-il2cpp-game-change.md)**. That lesson moves from "my DLL loads" to a small, reversible change in the running game.

After that, continue through **[Learn the Everyday Modding Loop](../learning-paths/everyday-modding/README.md)**.
