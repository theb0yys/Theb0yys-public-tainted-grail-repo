...
> **Reference page.** Use this when you need exact runtime, loader, or IL2CPP-reference details. If you are learning in order, return to the [first-mod learning path](../../getting-started/README.md).
