...
- the [technical handbook](../../../knowledge/reference/README.md);
- the [Content Domains](../../../knowledge/reference/content-domains.md) reference;
...
Use [Content Domains](../../../knowledge/reference/content-domains.md) as the map.

Then use [Research Method](../../tasks/reverse-engineering/discovery.md) to extract the next proven process from the working evidence.
