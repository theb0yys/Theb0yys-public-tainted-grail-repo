...
Continue to **[Move to a Real Game Patch](first-real-patch-rules.md)** for the rules around game-specific targets.

When your own small feature works end-to-end, use **[Finish Your First Complete Mod](first-complete-mod.md)** as the final beginner checkpoint.

If you want to understand the generated IL2CPP assemblies first, read **[Runtime Guide](../runtime-modding/runtime-guide.md)** and inspect your local `BepInEx\interop` directory.
