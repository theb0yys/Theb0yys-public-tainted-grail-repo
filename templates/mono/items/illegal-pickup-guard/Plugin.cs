...
namespace TGTemplate.IllegalPickupGuard;

[BepInPlugin(PluginGuid, PluginName, PluginVersion)]
public sealed class Plugin : BaseUnityPlugin
{
    public const string PluginGuid = "community.taintedgrail.template.illegal-pickup-guard";
    public const string PluginName = "TG Illegal Pickup Guard Template";
    ...
    private void Awake()
    {
        ...
        _modifier = Config.Bind("General", "RequiredModifier", KeyCode.LeftAlt, "Modifier held to allow an illegal pickup.");
...
internal static class IllegalPickablePatch
{
    ...
    {
        if (!Plugin.Enabled || !__instance.IsIllegal || Input.GetKey(Plugin.Modifier))
            return true;
